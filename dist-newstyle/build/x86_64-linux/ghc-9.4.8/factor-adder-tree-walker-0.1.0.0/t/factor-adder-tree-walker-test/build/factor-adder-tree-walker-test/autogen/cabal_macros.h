...
/* package factor-adder-tree-walker-0.1.0.0 */
#ifndef VERSION_factor_adder_tree_walker
#define VERSION_factor_adder_tree_walker "0.1.0.0"
#endif /* VERSION_factor_adder_tree_walker */
#ifndef MIN_VERSION_factor_adder_tree_walker
#define MIN_VERSION_factor_adder_tree_walker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_factor_adder_tree_walker */
...
/* package cabal-detailed-quickcheck-0.2.0.1 */
#ifndef VERSION_cabal_detailed_quickcheck
#define VERSION_cabal_detailed_quickcheck "0.2.0.1"
#endif /* VERSION_cabal_detailed_quickcheck */
#ifndef MIN_VERSION_cabal_detailed_quickcheck
#define MIN_VERSION_cabal_detailed_quickcheck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_cabal_detailed_quickcheck */
/* package factor-adder-tree-walker-0.1.0.0 */
#ifndef VERSION_factor_adder_tree_walker
#define VERSION_factor_adder_tree_walker "0.1.0.0"
#endif /* VERSION_factor_adder_tree_walker */
...
#define CURRENT_COMPONENT_ID "factor-adder-tree-walker-0.1.0.0-inplace-factor-adder-tree-walker-test"
